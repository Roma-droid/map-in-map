...
class DB_Map():
    ...
    def create_graph(self, path, cities):
        ...
        for city in cities:
            ...
            if coordinates:
                ...
                ax.text(lng + 0.5, lat + 0.5, city, transform=ccrs.PlateCarree())
        plt.savefig(path)
    ...
    def draw_distance(self, city1, city2):
        ...
        ax = plt.axes(projection=ccrs.PlateCarree())
        ax.coastlines()
        ax.plot([lng1, lng2], [lat1, lat2], marker='o', color='red', markersize=5, transform=ccrs.PlateCarree())
        ax.text(lng1 + 0.5, lat1 + 0.5, city1, transform=ccrs.PlateCarree())
        ax.text(lng2 + 0.5, lat2 + 0.5, city2, transform=ccrs.PlateCarree())
